<!-- Linha original 1: Inicia a seção visual do componente Vue. -->
<template>
  <section>
    <h1>Dashboard</h1>
    <p>Resumo das batidas do dia, funcionários ativos e pendências de validação.</p>
  </section>
</template>
