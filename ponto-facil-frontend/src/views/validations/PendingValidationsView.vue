...
<template>
  <section>
    ...
    <p>Compare as fotos e confirme ou rejeite batidas pendentes.</p>
  </section>
</template>
...
Linha original 3: <h1>Pendências de Validação</h1>
  -> Cria um título que organiza a hierarquia visual e semântica do conteúdo.
Linha original 4: <p>Compare as fotos e confirme ou rejeite batidas pendentes.</p>
